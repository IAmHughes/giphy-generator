...
For example, if I commnented on an Issue and included the phrase `/giphy another one`, I would see a comment from this action of a gif response from GIPHY's Search API for `another one`:
